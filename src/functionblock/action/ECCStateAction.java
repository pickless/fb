...
public class ECCStateAction extends DrawShapeDiagramAction {
	...
	public static String DRAW_ECC_STATE_ACTION = FunctionBlockConstants.ActionsConstants.ECC_STATE_DRAW_ACTION_ID;
	public static String SIMPLE_NAME = FunctionBlockConstants.ActionsConstants.ECC_STATE_HUMAN_NAME;

	public ECCStateAction() {
		super(DRAW_ECC_STATE_ACTION, SIMPLE_NAME, null);
		setLargeIcon(new ImageIconProxy(getClass(), FunctionBlockConstants.ActionsConstants.ECC_STATE_GIF_PATH, "")); 
	}

	protected Element createElement() {
		State state = Application.getInstance().getProject().getElementsFactory().createStateInstance();
		StereotypesHelper.addStereotypeByString(state, FunctionBlockConstants.StereotypesConstants.ECC_STATE);
		return state;
	}
